...
class TocabiEnv(gym.envs.mujoco.MujocoEnv):
    ...
    def __init__(self, model_path, frame_skip):
        ...
        self.mocap_data = np.genfromtxt('motions/processed_data_tocabi_squat.txt', encoding='ascii')
        ...
        self.action_last = self.action_space.sample()
        self.action_cur = np.copy(self.action_last)
        _, self.action_high = self.model.actuator_ctrlrange[0:12].copy().T
